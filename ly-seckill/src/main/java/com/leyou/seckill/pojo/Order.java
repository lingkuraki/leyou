...
import com.leyou.common.utils.LongJsonDeserializer;
import com.leyou.common.utils.LongJsonSerializer;
import lombok.Data;
...
public class Order {
    ...
    private String receiverState;// 省级行政区
    private String receiverCity;// 城市
    private String receiverDistrict;// 区/县
    private String receiverAddress;// 收货地址
    private String receiverZip;// 邮政编码

    private Integer invoiceType = 0;// 发票类型，0无发表，1普通发票，2电子发票，3增值税发票
