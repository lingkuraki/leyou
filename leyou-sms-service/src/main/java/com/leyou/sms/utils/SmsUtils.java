...
public class SmsUtils {
    ...
    public SendSmsResponse sendSms(String phone, String code, String signName, String template) throws ClientException {
        // 手动调整超时时间
        System.setProperty("sun.net.NetworkClient.defaultConnectTimeout", "10000");
        System.setProperty("sun.net.NetWorkClient.defaultReadTimeout", "10000");
        ...
        LOGGER.info("发送短息状态：{}", sendSmsResponse.getCode());
